# PowerShell script to setup Git security hooks on Windows

Write-Host "Setting up Git security hooks..." -ForegroundColor Green
...
Write-Host "✅ Git security hooks installed!" -ForegroundColor Green
Write-Host ""
Write-Host "The pre-commit hook will now:" -ForegroundColor Yellow
Write-Host "• Check for AWS keys, API keys, and other secrets" -ForegroundColor Yellow
Write-Host "• Prevent committing .env files" -ForegroundColor Yellow
Write-Host "• Block commits containing potential credentials" -ForegroundColor Yellow
Write-Host ""
Write-Host "To test: Try committing a file with 'password=secret123'" -ForegroundColor Cyan